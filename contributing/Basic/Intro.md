...
Welcome to the IntellectX Chat Technical Development Getting Started Guide. IntellectX Chat is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of IntellectX Chat and how to configure and use these technologies in your development environment.
...
The core technology stack of IntellectX Chat is as follows:
...
The folder directory structure of IntellectX Chat is as follows:
...
1. **Get the code**: Clone the IntellectX Chat code repository locally:
...
IntellectX Chat uses `i18next` and `lobe-i18n` to implement multilingual support, ensuring a global user experience.
...
To support developers in better understanding and using the technology stack of IntellectX Chat, we provide a comprehensive list of resources and references — [IntellectX Chat Resources and References](https://github.com/lobehub/lobe-chat/wiki/Resources.zh-CN) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [IntellectX Chat GitHub Discussions](https://github.com/lobehub/lobe-chat/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
