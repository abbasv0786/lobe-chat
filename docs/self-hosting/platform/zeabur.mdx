---
title: Deploy IntellectX Chat on Zeabur
description: >-
  Learn how to deploy IntellectX Chat on Zeabur with ease. Follow the provided steps to
...
# Deploy IntellectX Chat with Zeabur

If you want to deploy IntellectX Chat on Zeabur, you can follow the steps below:
...
# Deploy IntellectX Chat with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy IntellectX Chat as a serverless function service. To deploy IntellectX Chat as a serverless function service on Zeabur, you can follow the steps below:

## Zeabur Deployment Process

<Steps>

### Fork IntellectX Chat
...
### Link your fork of IntellectX Chat to the just created Zeabur service.
