---
title: Deploy IntellectX Chat with Docker Compose
description: >-
  Learn how to deploy the IntellectX Chat service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the IntellectX Chat service on your private device.
