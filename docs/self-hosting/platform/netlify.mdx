---
title: Deploy IntellectX Chat with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy IntellectX Chat on Netlify with detailed instructions on forking
...
# Deploy IntellectX Chat with Netlify

If you want to deploy IntellectX Chat on Netlify, you can follow these steps:

## Deploy IntellectX Chat with Netlify

<Steps>
  ### Fork the IntellectX Chat Repository

Click the Fork button to fork the IntellectX Chat repository to your GitHub account.
...
Next, select the IntellectX Chat project:

<Image
  alt={'Select the IntellectX Chat github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure IntellectX Chat site name'}
  height={712}
  inStep
...
<Image
  alt={'Add IntellectX Chat site environment variables'}
  height={537}
  inStep
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by IntellectX Chat, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your IntellectX Chat is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'IntellectX Chat deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your IntellectX Chat has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your IntellectX Chat site.

  <Image alt={'Access Your IntellectX Chat Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
