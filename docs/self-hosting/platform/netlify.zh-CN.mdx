---
title: 在 Netlify 上部署 IntellectX Chat
description: >-
  学习如何在 Netlify 上部署 IntellectX Chat，包括 Fork 仓库、准备 OpenAI API Key、导入到 Netlify
  工作台、配置站点名称与环境变量等步骤。
tags:
  - Netlify
  - IntellectX Chat
...
如果想在 Netlify 上部署 IntellectX Chat，可以按照以下步骤进行操作：

## Netlify 部署 IntellectX Chat

<Steps>
  ### Fork IntellectX Chat 仓库

点击 Fork 按钮，将 IntellectX Chat 仓库 Fork 到你的 GitHub 账号下。
...
然后选择 IntellectX Chat 项目：

<Image
  alt={'选择 IntellectX Chat github 项目'}
  height={228}
  inStep
...
<Callout type={'tip'}>
  IntellectX Chat 支持的完整环境变量列表请参考 [📘 环境变量](/docs/self-hosting/environment-variables) 部分
</Callout>
...
进入部署详情，你会看到下述界面，这意味着你的 IntellectX Chat 正在部署中，只需等待部署完成即可。

<Image
  alt={'IntellectX Chat 部署构建中'}
  height={325}
  inStep
...
如果你的界面中的 Deploy Log 如下所示，意味着你的 IntellectX Chat 部署成功了。
...
此时，你可以点击「Open production deploy」，即可访问你的 IntellectX Chat 站点

  <Image alt={'访问你的 IntellectX Chat 站点'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
