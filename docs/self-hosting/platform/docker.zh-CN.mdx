---
title: 通过 Docker 部署 IntellectX Chat
description: 学习如何使用 Docker 部署 IntellectX Chat 服务，包括安装 Docker 容器环境和使用指令一键启动服务。详细说明如何配置环境变量和使用代理地址。
tags:
  - Docker
  - IntellectX Chat
  - 部署指引
...
我们提供了 [Docker 镜像][docker-release-link]，供你在自己的私有设备上部署 IntellectX Chat 服务。
...
使用以下命令即可使用一键启动 IntellectX Chat 服务：
