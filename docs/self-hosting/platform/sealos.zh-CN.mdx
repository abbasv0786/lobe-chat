---
title: 在 SealOS 上部署 IntellectX Chat
description: 学习如何在 SealOS 上部署 IntellectX Chat，包括准备 OpenAI API Key、点击部署按钮、绑定自定义域名等操作。
tags:
  - SealOS
  - IntellectX Chat
  - OpenAI API Key
...
如果想在 SealOS 上部署 IntellectX Chat，可以按照以下步骤进行操作：
