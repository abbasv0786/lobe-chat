---
title: IntellectX Chat 身份验证服务设置
description: 了解如何配置 IntellectX Chat 的身份验证服务环境变量。
tags:
  - IntellectX Chat
  - 身份验证服务
  - 单点登录
...
IntellectX Chat 在部署时提供了完善的身份验证服务能力，以下是相关的环境变量，你可以使用这些环境变量轻松定义需要在 IntellectX Chat 中开启的身份验证服务。
