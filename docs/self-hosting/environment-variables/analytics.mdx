---
title: Integrating Analytics in IntellectX Chat
description: >-
  Learn how to configure environment variables for Vercel Analytics, Google
  Analytics, PostHog Analytics, and Umami Analytics in IntellectX Chat for data
...
We have integrated several free/open-source data analytics services in IntellectX Chat for collecting user usage data. Here are environment variables that you can use.
