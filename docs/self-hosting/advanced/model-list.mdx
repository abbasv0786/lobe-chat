---
title: Customizing Provider Model List in IntellectX Chat for Deployment
description: >-
  Learn how to customize the model list in IntellectX Chat for deployment with the
