...
description: >-
  Learn how to import and export configuration settings for IntellectX Chat via URL.
...
IntellectX Chat support import settings from external URL to quickly set up IntellectX Chat configuration.
...
<Callout type={'warning'}>
  IntellectX Chat does not verify the correctness of the settings parameters in the URL, nor provide
