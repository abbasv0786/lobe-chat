---
title: Configure ZITADEL Authentication Service for IntellectX Chat
description: >-
  Learn how to configure ZITADEL Authentication Service for IntellectX Chat deployment,
  including creating ZITADEL applications, setting up environment variables, and
  enabling single sign-on (SSO).
tags:
  - ZITADEL Authentication
  - IntellectX Chat Deployment
  - Single Sign-On (SSO)
...
- Replace `http(s)://your-domain` with the actual URL that IntellectX Chat is deployed to.
...
<Callout>
  After successful deployment, users will be able to authenticate and use IntellectX Chat using existing
