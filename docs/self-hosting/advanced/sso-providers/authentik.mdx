---
title: Configuring Authentik Authentication Service for IntellectX Chat
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for IntellectX Chat,
  including creating an application provider, setting environment variables, and
  deployment instructions.
tags:
  - Authentik Configuration
  - Single Sign-On (SSO)
  - IntellectX Chat Authentication
...
<Callout type={'info'}>
  After a successful deployment, users will be able to use IntellectX Chat by authenticating with the users
