---
title: Configuring Github Authentication Service for IntellectX Chat
description: >-
  Learn how to configure Github authentication service for IntellectX Chat, including
...
| `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for IntellectX Chat. Use `github` for Github. |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use IntellectX Chat.
</Callout>
