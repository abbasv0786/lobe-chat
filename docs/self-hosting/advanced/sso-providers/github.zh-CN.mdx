---
title: 在 IntellectX Chat 中配置 Github 身份验证服务
description: 学习如何在 IntellectX Chat 中配置Github身份验证服务，包括创建新的Github App、设置权限和环境变量。
tags:
  - Github 身份验证
  - Github App
  - 环境变量配置
...
<Callout type={'info'}>部署成功后，用户将可以通过Github身份认证并使用 IntellectX Chat。</Callout>
