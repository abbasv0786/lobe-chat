---
title: Configure Auth0 Identity Verification Service for IntellectX Chat
description: >-
  Learn how to configure Auth0 Identity Verification Service for IntellectX Chat for
...
Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to IntellectX Chat.
...
When deploying IntellectX Chat, you need to configure the following environment variables:
...
<Callout>
  After successful deployment, users will be able to authenticate and use IntellectX Chat using the users
  configured in Auth0.
</Callout>
...
<Callout type={'warning'}>
  ...
  IntellectX Chat being abused by external users.
</Callout>
