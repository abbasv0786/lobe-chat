---
title: Integrating Data Analytics Services in IntellectX Chat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in IntellectX Chat to
...
To better help analyze the usage of IntellectX Chat users, we have integrated several free/open-source data analytics services in IntellectX Chat for collecting user usage data, which you can enable as needed.
