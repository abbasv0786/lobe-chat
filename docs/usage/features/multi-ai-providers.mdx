---
title: IntellectX Chat with Multi AI Providers
description: >-
  Discover how IntellectX Chat offers diverse model service provider support, including
...
To meet the specific needs of users, IntellectX Chat also supports the use of local models based on [Ollama](https://ollama.ai), allowing users to flexibly use their own or third-party models. For more details, see [Local Model Support](/docs/usage/features/local-llm).
