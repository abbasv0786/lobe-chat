---
title: 在 IntellectX Chat 中使用 Google Gemini API Key
description: 本文将指导你如何在 IntellectX Chat 中配置并使用 Google Gemini，一个由 Google AI 创建的强大语言模型。
tags:
  - Google Gemini
  - Google AI
  - API 密钥
...
# 在 IntellectX Chat 中使用 Google Gemini

<Image
  alt={'在 IntellectX Chat 中使用 Google Gemini'}
  cover
...
本文档将指导你如何在 IntellectX Chat 中使用 Google Gemini:
...
### 步骤二：在 IntellectX Chat 中配置OpenAI

- 访问IntellectX Chat的`设置`界面
- 在`语言模型`下找到`Google Gemini`的设置项

<Image
  alt={'IntellectX Chat 中填写 Google Gemini API 密钥'}
  inStep
...
至此，你已经可以在 IntellectX Chat 中使用 Google Gemini 啦。
