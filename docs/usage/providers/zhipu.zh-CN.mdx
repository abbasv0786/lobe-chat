---
title: 在 IntellectX Chat 中使用智谱 ChatGLM API Key
description: 学习如何在 IntellectX Chat 中配置和使用智谱AI的 API Key，开始与智谱AI提供的模型进行对话。
tags:
  - 智谱AI
  - ChatGLM
  - API Key
...
# 在 IntellectX Chat 中使用智谱 ChatGLM
...
本文档将指导你如何在 IntellectX Chat 中使用智谱 AI:
...
### 步骤二：在 IntellectX Chat 中配置智谱AI

- 访问IntellectX Chat的`设置`界面
- 在`语言模型`下找到`智谱AI`的设置项

<Image
  alt={'IntellectX Chat 中填写智谱AI API 密钥'}
  inStep
...
至此你已经可以在 IntellectX Chat 中使用智谱AI提供的模型进行对话了。
