---
title: Using Zhipu ChatGLM API Key in IntellectX Chat
description: >-
  Learn how to integrate and utilize Zhipu AI models in IntellectX Chat for enhanced
...
# Using Zhipu ChatGLM in IntellectX Chat

<Image
  alt={'Using Together AI in IntellectX Chat'}
  cover
...
This document will guide you on how to use Zhipu AI in IntellectX Chat:
...
You can now engage in conversations using the models provided by Zhipu AI in IntellectX Chat.
