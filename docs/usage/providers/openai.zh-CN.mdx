---
title: 在 IntellectX Chat 中使用 OpenAI API Key
description: 学习如何在 IntellectX Chat 中配置和使用 OpenAI API Key，支持 GPT-4o / GPT-4-turbo / GPT-4-vision
tags:
  - ChatGPT
  - GPT-4
  - GPT-4o
...
# 在 IntellectX Chat 中使用 OpenAI

<Image
  alt={'在 IntellectX Chat 中使用 OpenAI'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'}
/>

本文档将指导你如何在 IntellectX Chat 中使用 [OpenAI](https://openai.com/):
...
### 步骤二：在 IntellectX Chat 中配置 OpenAI
...
至此你已经可以在 IntellectX Chat 中使用 OpenAI 提供的模型进行对话了。
