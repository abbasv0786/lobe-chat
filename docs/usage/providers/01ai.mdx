---
title: Using Zero One AI API Key in IntellectX ChattXChat
description: >-
  Learn how to integrate and use Zero One AI in IntellectX ChattXChat with step-by-step
...
# Using Zero One AI in IntellectX ChattXChat

<Image
  alt={'Using Zero One AI in IntellectX ChattXChat'}
  cover
...
This document will guide you on how to use Zero One AI in IntellectX ChattXChat:
...
### Step 2: Configure Zero One AI in IntellectX ChattXChat
...
You can now use the models provided by Zero One AI for conversations in IntellectX ChattXChat.
