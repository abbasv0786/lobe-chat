---
title: 在 IntellectX Chat 中使用本地通义千问 Qwen 模型
description: 通过 IntellectX Chat 与 Ollama 的集成，轻松在本地部署的通义千问 Qwen 模型中进行对话。学习如何安装和选择 Qwen 模型。
tags:
  - 通义千问
  - Qwen模型
  - IntellectX Chat集成
...
<Image
  alt={'在 IntellectX Chat 中使用 Qwen'}
  cover
...
现在，通过 IntellectX Chat 与 [Ollama](https://ollama.com/) 的集成，你可以轻松地在 IntellectX Chat 中使用 通义千问。

本文档将指导你如何在 IntellectX Chat 中使用通义千问本地部署版：
...
接下来，你就可以使用 IntellectX Chat 与本地 Qwen 模型对话了。
