---
title: Using OpenAI API Key in IntellectX Chat
description: >-
  Learn how to integrate OpenAI API Key in IntellectX Chat. Support GPT-4o /
...
# Using OpenAI in IntellectX Chat

<Image
  alt={'Using OpenAI in IntellectX Chat'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'}
/>

This document will guide you on how to use [OpenAI](https://openai.com/) in IntellectX Chat:
...
- Visit the `Settings` page in IntellectX Chat
...
You can now engage in conversations using the models provided by OpenAI in IntellectX Chat.
