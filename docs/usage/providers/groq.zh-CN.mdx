---
title: 在 IntellectX Chat 中使用 Groq API Key
description: 了解如何获取 GroqCloud API Key，并在 IntellectX Chat 中配置 Groq，体验 Groq 强大的性能。
tags:
  - LLAMA3
  - Qwen2
  - API keys
...
# 在 IntellectX Chat 中使用 Groq

<Image
  alt={'在 IntellectX Chat 中使用 Groq'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/1d840e27-fa74-4e71-b777-330bf41d6dff'}
/>

Groq 的 [LPU 推理引擎](https://wow.groq.com/news_press/groq-lpu-inference-engine-leads-in-first-independent-llm-benchmark/) 在最新的独立大语言模型（LLM）基准测试中表现卓越，以其惊人的速度和效率重新定义了 AI 解决方案的标准。通过 IntellectX Chat 与 Groq Cloud 的集成，你现在可以轻松地利用 Groq 的技术，在 IntellectX Chat 中加速大语言模型的运行。
...
本文档将指导你如何在 IntellectX Chat 中使用 Groq：
...
接下来，在助手的模型选项中，选中一个 Groq 支持的模型，就可以在 IntellectX Chat 中体验 Groq 强大的性能了。
