---
title: 在 IntellectX ChattXChat 中使用 01.AI 零一万物 API Key
description: >-
  学习如何在 IntellectX ChattXChat 中配置并使用 01.AI 零一万物提供的 AI 模型进行对话。获取 API 密钥、填入设置项、选择模型，开始与 AI
  助手交流。
tags:
...
# 在 IntellectX ChattXChat 中使用零一万物

<Image
  alt={'在 IntellectX ChattXChat 中使用零一万物'}
  cover
...
本文档将指导你如何在 IntellectX ChattXChat 中使用零一万物:
...
### 步骤二：在IntellectX ChattXChat 中配置零一万物
...
至此你已经可以在 IntellectX ChattXChat 中使用零一万物提供的模型进行对话了。
