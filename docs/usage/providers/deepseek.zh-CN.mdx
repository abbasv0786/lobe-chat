---
title: 在 IntellectX Chat 中使用 DeepSeek API Key
description: 学习如何在 IntellectX Chat 中配置和使用 DeepSeek 语言模型，获取 API 密钥并开始对话。
tags:
  - IntellectX Chat
  - DeepSeek
  - API密钥
...
# 在 IntellectX Chat 中使用 DeepSeek

<Image
  alt={'在 IntellectX Chat 中使用 DeepSeek'}
  cover
...
本文档将指导你如何在 IntellectX Chat 中使用 DeepSeek:
...
### 步骤二：在 IntellectX Chat 中配置 DeepSeek

- 访问 IntellectX Chat 的 `应用设置`界面
...
至此你已经可以在 IntellectX Chat 中使用 Deepseek 提供的模型进行对话了。
