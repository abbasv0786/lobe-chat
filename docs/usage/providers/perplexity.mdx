---
title: Using Perplexity AI API Key in IntellectX Chat
description: >-
  Learn how to integrate and use Perplexity AI in IntellectX Chat to enhance your AI
...
# Using Perplexity AI in IntellectX Chat

<Image
  alt={'Using Perplexity AI in IntellectX Chat'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/0c2c399f-2ed3-44b5-97c8-53e007e8c095'}
/>

The Perplexity AI API is now available for everyone to use. This document will guide you on how to use [Perplexity AI](https://www.perplexity.ai/) in IntellectX Chat:
...
### Step 2: Configure Perplexity AI in IntellectX Chat

- Go to the `Settings` interface in IntellectX Chat
...
You can now engage in conversations using the models provided by Perplexity AI in IntellectX Chat.
