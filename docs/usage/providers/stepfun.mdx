---
title: Using Stepfun API Key in IntellectX Chat
description: >-
  Learn how to integrate Stepfun AI models into IntellectX Chat for engaging
  conversations. Obtain Stepfun API key, configure Stepfun in IntellectX Chat settings,
...
# Using Stepfun in IntellectX Chat

<Image
  alt={'Using Stepfun in IntellectX Chat'}
  cover
...
This document will guide you on how to use Stepfun in IntellectX Chat:
...
### Step 2: Configure Stepfun in IntellectX Chat
...
You can now use the models provided by Stepfun to have conversations in IntellectX Chat.
