---
title: Using Qwen2 API Key in IntellectX Chat
description: >-
  Learn how to integrate and utilize Tongyi Qianwen, a powerful language model
  by Alibaba Cloud, in IntellectX Chat for various tasks. Follow the steps to activate
...
# Using Tongyi Qianwen in IntellectX Chat

<Image
  alt={'Using Tongyi Qianwen in IntellectX Chat'}
  cover
...
This document will guide you on how to use Tongyi Qianwen in IntellectX Chat:
...
### Step 3: Configure Tongyi Qianwen in IntellectX Chat
...
You can now engage in conversations using the models provided by Tongyi Qianwen in IntellectX Chat.
