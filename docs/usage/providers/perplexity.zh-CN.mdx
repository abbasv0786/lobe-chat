---
title: 在 IntellectX Chatt 中使用 Perplexity AI API Key
description: 学习如何在 IntellectX Chatt 中配置和使用 Perplexity AI，获取 API 密钥并选择适合的语言模型开始对话。
tags:
  - Perplexity AI
  - API key
  - Web UI
...
# 在 IntellectX Chatt 中使用 Perplexity AI

<Image
  alt={'在 IntellectX Chatt 中使用 Perplexity AI'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/0c2c399f-2ed3-44b5-97c8-53e007e8c095'}
/>

Perplexity AI API 现在可供所有人使用, 本文档将指导你如何在 IntellectX Chatt 中使用 [Perplexity AI](https://www.perplexity.ai/):
...
### 步骤二：在 IntellectX Chatt 中配置 Perplexity AI

- 访问 IntellectX Chatt 的`设置`界面
...
至此你已经可以在 IntellectX Chatt 中使用 Perplexity AI 提供的模型进行对话了。
