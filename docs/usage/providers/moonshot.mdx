---
title: Using Moonshot AI API Key in IntellectX Chat
description: >-
  Learn how to integrate Moonshot AI into IntellectX Chat for AI-powered conversations.
...
# Using Moonshot AI in IntellectX Chat

<Image
  alt={'Using Moonshot AI in IntellectX Chat'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/21b94782-875b-4dee-a572-3c5843f3e1e3'}
/>

The Moonshot AI API is now available for everyone to use. This document will guide you on how to use [Moonshot AI](https://www.moonshot.cn/) in IntellectX Chat:
...
### Step 2: Configure Moonshot AI in IntellectX Chat
...
You can now engage in conversations using the models provided by Moonshot AI in IntellectX Chat.
