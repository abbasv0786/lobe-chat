---
title: Using Together AI in IntellectX Chat API Key
description: >-
  Learn how to integrate Together AI into IntellectX Chat, obtain the API key,
...
# Using Together AI in IntellectX Chat
...
This document will guide you on how to use Together AI in IntellectX Chat:
...
You can now engage in conversations using the models provided by Together AI in IntellectX Chat.
