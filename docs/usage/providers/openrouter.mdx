---
title: Using OpenRouter API Key in IntellectX Chat
description: >-
  Learn how to integrate and utilize OpenRouter's language model APIs in
  IntellectX Chat. Follow these steps to register, create an API key, recharge credit,
...
# Using OpenRouter in IntellectX Chat

<Image
  alt={'Using OpenRouter in IntellectX Chat'}
  cover
...
This document will guide you on how to use OpenRouter in IntellectX Chat:
...
- Name your API key in the pop-up dialog, for example, "IntellectX Chat Key"
...
### Step 4: Configure OpenRouter in IntellectX Chat

- Visit the `Settings` interface in IntellectX Chat
- Find the setting for `OpenRouter` under `Language Models`
- Enable OpenRouter and enter the API key you obtained

<Image
  alt={'Configure OpenRouter in IntellectX Chat'}
  height={518}
  inStep
...
You can now engage in conversations using the models provided by OpenRouter in IntellectX Chat.
