---
title: 在 IntellectX Chat 中使用 Together AI API Key
description: 学习如何在 IntellectX Chat 中配置和使用 Together AI 的API Key，以便开始对话和交互。
tags:
  - IntellectX Chat
  - Together AI
  - API密钥
...
# 在 IntellectX Chat 中使用 Together AI

<Image
  alt={'在 IntellectX Chat 中使用 Together AI'}
  cover
...
本文档将指导你如何在 IntellectX Chat 中使用 Together AI:
...
### 步骤二：在 IntellectX Chat 中配置 Together AI

- 访问IntellectX Chat的`设置`界面
- 在`语言模型`下找到`together.ai`的设置项

<Image
  alt={'IntellectX Chat 中填写 Together AI API 密钥'}
  inStep
...
至此你已经可以在 IntellectX Chat 中使用 Together AI 提供的模型进行对话了。
