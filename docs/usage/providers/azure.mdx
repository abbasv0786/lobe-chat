---
title: Using Azure OpenAI API Key in IntellectX ChattXChat
description: >-
  Learn how to integrate and configure Azure OpenAI in IntellectX ChattXChat to enhance your
...
# Using Azure OpenAI in IntellectX ChattXChat

<Image
  alt={'Azure OpenAI in IntellectX ChattXChat'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13'}
/>

This document will guide you on how to use [Azure OpenAI](https://oai.azure.com/) in IntellectX ChattXChat:
...
### Step 2: Configure Azure OpenAI in IntellectX ChattXChat
...
Now you can engage in conversations using the models provided by Azure OpenAI in IntellectX ChattXChat.
