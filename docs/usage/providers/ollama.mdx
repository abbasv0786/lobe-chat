---
title: Using Ollama in IntellectX Chat
description: >-
  Learn how to use Ollama in IntellectX Chat, run LLM locally, and experience
...
# Using Ollama in IntellectX Chat

<Image
  alt={'Using Ollama in IntellectX Chat'}
  borderless
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/f579b39b-e771-402c-a1d1-620e57a10c75'}
/>

Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, IntellectX Chat supports integration with Ollama, meaning you can easily enhance your application by using the language models provided by Ollama in IntellectX Chat.

This document will guide you on how to use Ollama in IntellectX Chat:

<Video
  alt="demonstration of using Ollama in IntellectX Chat"
  height={580}
...
### Conversing with Local Large Models in IntellectX Chat

Now, you can start conversing with the local LLM in IntellectX Chat.

<Image
  alt="Chat with llama3 in IntellectX Chat"
  height="573"
...
### Installation in IntellectX Chat

In IntellectX Chat, we have enabled some common large language models by default, such as llama3, Gemma, Mistral, etc. When you select a model for conversation, we will prompt you to download that model.

<Image
  alt="IntellectX Chat guide your to install Ollama model"
  height="460"
...
<Callout type={'info'}>
  ...
  IntellectX Chat to meet integration needs with Ollama.
</Callout>
