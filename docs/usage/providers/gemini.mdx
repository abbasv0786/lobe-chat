---
title: Using Google Gemini API Key in IntellectX Chat
description: >-
  Learn how to integrate and utilize Google Gemini AI in IntellectX Chat to enhance
...
# Using Google Gemini in IntellectX Chat

<Image
  alt={'Using Google Gemini in IntellectX Chat'}
  cover
...
This document will guide you on how to use Google Gemini in IntellectX Chat:
...
Congratulations! You can now use Google Gemini in IntellectX Chat.
