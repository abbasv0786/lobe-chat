---
title: Using Minimax API Key in IntellectX Chat
description: >-
  Learn how to use MiniMax in IntellectX Chat to enhance AI conversations. Obtain
  MiniMax API key, configure MiniMax in IntellectX Chat settings, and select a model
...
# Using Minimax in IntellectX Chat

<Image
  alt={'Using Minimax in IntellectX Chat'}
  cover
...
This document will guide you on how to use Minimax in IntellectX Chat:
...
### Step 2: Configure MiniMax in IntellectX Chat

- Go to the `Settings` interface of IntellectX Chat
...
You can now use the models provided by MiniMax to have conversations in IntellectX Chat.
