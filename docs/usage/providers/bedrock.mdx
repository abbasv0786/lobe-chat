---
title: Using Amazon Bedrock API Key in IntellectX ChattXChat
description: >-
  Learn how to integrate Amazon Bedrock models into IntellectX ChattXChat for AI-powered
...
# Using Amazon Bedrock in IntellectX ChattXChat

<Image
  alt={'Using Amazon Bedrock in IntellectX ChattXChat'}
  cover
...
This document will guide you on how to use Amazon Bedrock in IntellectX ChattXChat:
...
### Step 3: Configure Amazon Bedrock in IntellectX ChattXChat
...
<Image
  alt={'Enter Amazon Bedrock keys in IntellectX ChattXChat'}
  inStep
...
You can now engage in conversations using the models provided by Amazon Bedrock in IntellectX ChattXChat.
