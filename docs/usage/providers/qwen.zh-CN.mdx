---
title: 在 IntellectX Chat 中使用通义千问 API Key
description: 学习如何在 IntellectX Chat 中配置和使用阿里云的通义千问模型，提供强大的自然语言理解和生成能力。
tags:
  - IntellectX Chat
  - 通义千问
  - DashScope
...
# 在 IntellectX Chat 中使用通义千问

<Image
  alt={'在 IntellectX Chat 中使用通义千问'}
  cover
...
本文档将指导你如何在 IntellectX Chat 中使用通义千问:
...
至此你已经可以在 IntellectX Chat 中使用通义千问提供的模型进行对话了。
