---
title: 在 IntellectX ChattXChat 中使用 Anthropic Claude API Key
description: >-
  学习如何在 IntellectX ChattXChat 中配置和使用 Anthropic Claude API， Claude 3.5 sonnet / Claude 3 Opus
  / Claude 3 haiku
tags:
  - Anthropic Claude
  - API
...
# 在 IntellectX ChattXChat 中使用 Anthropic Claude

<Image
  alt={'在 IntellectX ChattXChat 中使用 Anthropic Claude'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/620b956b-dcb2-442a-8bb1-9aa22681dfa4'}
/>

Anthropic Claude API 现在可供所有人使用, 本文档将指导你如何在 IntellectX ChattXChat 中使用 [Anthropic Claude](https://www.anthropic.com/api):
...
### 步骤二：在 IntellectX ChattXChat 中配置 Anthropic Claude

- 访问 IntellectX ChattXChat 的`设置`界面
...
至此你已经可以在 IntellectX ChattXChat 中使用 Anthropic Claude 提供的模型进行对话了。
