---
title: Using DeepSeek API Key in IntellectX Chat
description: >-
  Learn how to use DeepSeek-V2 in IntellectX Chat, obtain API keys. Get started with
...
# Using DeepSeek in IntellectX Chat

<Image
  alt={'Using DeepSeek in IntellectX Chat'}
  cover
...
This document will guide you on how to use DeepSeek in IntellectX Chat:
...
### Step 2: Configure DeepSeek in IntellectX Chat

- Access the `App Settings` interface in IntellectX Chat.
...
You can now engage in conversations using the models provided by Deepseek in IntellectX Chat.
