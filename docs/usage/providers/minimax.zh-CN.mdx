---
title: 在 IntellectX Chat 中使用 Minimax API Key
description: >-
  学习如何在 IntellectX Chat 中配置并使用 MiniMax 智能模型进行对话。获取 MiniMax API 密钥、配置步骤详解，开始与 MiniMax
  模型交互。
tags:
  - IntellectX Chat
  - MiniMax
...
# 在 IntellectX Chat 中使用 Minimax

<Image
  alt={'在 IntellectX Chat 中使用 Minimax'}
  cover
...
本文档将指导你如何在 IntellectX Chat 中使用 Minimax:
...
### 步骤二：在IntellectX Chat 中配置 MiniMax
...
至此你已经可以在 IntellectX Chat 中使用 MiniMax 提供的模型进行对话了。
