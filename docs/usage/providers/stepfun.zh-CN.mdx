---
title: 在 IntellectX Chat 中使用 Stepfun 阶跃星辰 API Key
description: 学习如何在 IntellectX Chat 中配置和使用 Stepfun 阶跃星辰的人工智能模型，包括获取 API Key 和选择模型开始对话。
tags:
  - Stepfun 阶跃星辰
  - API key
  - Web UI
...
# 在 IntellectX Chat 中使用 Stepfun 阶跃星辰

<Image
  alt={'在 IntellectX Chat 中使用 Stepfun 阶跃星辰'}
  cover
...
本文档将指导你如何在 IntellectX Chat 中使用 Stepfun 阶跃星辰:
...
### 步骤二：在IntellectX Chat 中配置 Stepfun Stepfun 阶跃星辰
...
至此你已经可以在 IntellectX Chat 中使用 Stepfun 阶跃星辰提供的模型进行对话了。
