---
title: IntellectXChat Plugin Store
description: >-
  Learn how to access the Plugin Store in IntellectXChat to easily install and use
...
In the plugin store, you can directly install and use plugins in IntellectXChat.
