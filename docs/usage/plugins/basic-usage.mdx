---
title: Enhance Your IntellectX Chat Assistant with Plugins
description: >-
  Learn how to expand your IntellectX Chat assistant's capabilities by enabling and
...
The plugin system is a key element in expanding the capabilities of assistants in IntellectX Chat. You can enhance the assistant's abilities by enabling a variety of plugins.

Watch the following video to quickly get started with using IntellectX Chat plugins:
...
The Plugin Store allows you to directly install and use plugins within IntellectX Chat.
