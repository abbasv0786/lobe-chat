...
import LogoText from './components/IntellectXChatText';
// import Logo3d from './components/Logo3d';
import LogoFlat from './components/LogoFlat';
import LogoMono from './components/LogoMono';
import { useStyles } from './style';

export interface IntellectXChatProps extends DivProps {
  /**
...
const IntellectXChat = memo<IntellectXChatProps>(
      ...
      case 'combine': {
        logoComponent = (
          <>
            ...
            <strong style={{ fontSize: size, marginLeft: Math.round(size / 4), }}>IntellectX Chat</strong>
          </>
        );
