...
import LogoText from './components/IntellectXText';
// import Logo3d from '@lobehub/ui/brand';
import LogoFlat from './components/LogoFlat';
import LogoMono from './components/LogoMono';
import { useStyles } from './style';

export interface IntellectXProps extends DivProps {
  /**
...
const IntellectX = memo<IntellectXProps>(
