          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'IntellectX Chat is an AI conversation application built with the Next.js framework. I will help you write the development documentation for IntellectX Chat.',
                tags: [
                ...
                title: 'IntellectX Chat Technical Documentation Expert',
              },
              type: 'agent',
