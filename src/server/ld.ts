...
import { EMAIL_SUPPORT, OFFICIAL_SITE, OFFICIAL_URL, X } from '@/const/url';
...
class Ld {
  ...
  private fixTitle(title: string) {
    return title.includes('IntellectX Chat') ? title : `${title} · IntellectX Chat`;
  }
