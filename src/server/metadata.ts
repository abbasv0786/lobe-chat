...
export class Meta {
  public generate({
    description = 'IntellectX Chat offers you the best ChatGPT, OLLaMA, Gemini, Claude WebUI user experience',
    title,
    image = OG_URL,
    url,
    type = 'website',
    ...
    const siteTitle = title.includes('IntellectX Chat') ? title : title + ' · IntellectX Chat';
    return {
