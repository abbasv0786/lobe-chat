...
export const UTM_SOURCE = 'https://intellectx.ai/';

export const OFFICIAL_URL = 'https://intellectx.ai/';
export const OFFICIAL_PREVIEW_URL = 'https://intellectx.ai/';
export const OFFICIAL_SITE = 'https://intellectx.ai/';
...
export const EMAIL_SUPPORT = 'contact@intellectx.ai';

// export const MEDIDUM = 'https://medium.com/@lobehub';
export const X = 'https://x.com/pankajmathur_';
